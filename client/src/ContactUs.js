...
const Contactus = () => {
    return (
        <div className="container pb-5">
            <Nav />
            <br />
            <img src={Pic} alt="this is map" className="pic pb-4" />
            <h5>
            {/* email icon */}
           ...
           </svg> 19 Zarkashi Street, Kemal Al Kilani, Amman-Jordan
           <br></br>
           ...
           </svg> working hours 8:30 AM - 8:30 PM
           <br></br>
